...
def acq_mono3(device1, device2, num):
    ...
    DMD.SetTiming(illuminationTime=100000, pictureTime=100000)
    ...
    # 200000 equal to 0.2 second (in 1 second 5 pictures can be printed) X
    # Unit Conversion 1s = 1000000us 
    image_list = []
